...
public class TestsBlobStorage : MonoBehaviour
{
    ...
    {
        var nameFileWithExtesion = "";
        await BlobStorageManager.Instance.UploadOrUpdateBlockBlobAsync(Application.streamingAssetsPath, "", nameFileWithExtesion, () => print("Start upload..."), () => print("Upload done"));
    }
